                ...
                <div className="bg-white p-4 rounded-lg shadow-sm">
                    ...
                    <div className="space-y-2">
                        <div className="p-2 bg-blue-50 rounded text-xs">
                            <span className="font-medium">New delivery instruction:</span> Use service elevator for high-rise buildings
                        </div>
                        <div className="p-2 bg-green-50 rounded text-xs">
                            <span className="font-medium">Route updated:</span> I-95 traffic cleared, faster route available
                        </div>
                    </div>
                </div>
            </div>
